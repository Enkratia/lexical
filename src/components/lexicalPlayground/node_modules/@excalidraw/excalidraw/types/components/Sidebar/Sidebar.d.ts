...
import "@excalidraw/excalidraw/types/components/Sidebar/Sidebar.scss";
/**
...
export declare const Sidebar: React.ForwardRefExoticComponent<{
    ...
    Trigger: {
        ({ name, tab, icon, title, children, onToggle, className, style, }: import("@excalidraw/excalidraw/types/components/Sidebar/common").SidebarTriggerProps): JSX.Element;
        displayName: string;
    };
};
