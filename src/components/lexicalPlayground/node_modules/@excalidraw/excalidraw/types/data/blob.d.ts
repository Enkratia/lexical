import { IMAGE_MIME_TYPES, MIME_TYPES } from "@excalidraw/excalidraw/types/constants";
import { ExcalidrawElement, FileId } from "@excalidraw/excalidraw/types/element/types";
import { AppState, DataURL, LibraryItem } from "@excalidraw/excalidraw/types/types";
import { ValueOf } from "@excalidraw/excalidraw/types/utility-types";
...
export declare const loadSceneOrLibraryFromBlob: (blob: Blob | File, localAppState: AppState | null, localElements: readonly ExcalidrawElement[] | null, fileHandle?: FileSystemHandle | null) => Promise<{
    ...
    data: import("@excalidraw/excalidraw/types/data/restore").RestoredDataState;
} | {
    type: "application/vnd.excalidrawlib+json";
    data: ImportedLibraryData;
}>;
export declare const loadFromBlob: (blob: Blob, localAppState: AppState | null, localElements: readonly ExcalidrawElement[] | null, fileHandle?: FileSystemHandle | null) => Promise<import("@excalidraw/excalidraw/types/data/restore").RestoredDataState>;
