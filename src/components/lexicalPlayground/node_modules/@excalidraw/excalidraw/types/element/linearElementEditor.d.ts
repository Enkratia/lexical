import { NonDeleted, ExcalidrawLinearElement, ExcalidrawElement, PointBinding, ExcalidrawBindableElement, ExcalidrawTextElementWithContainer } from "@excalidraw/excalidraw/types/element/types";
import { Bounds } from "@excalidraw/excalidraw/types/element/bounds";
import { Point, AppState, PointerCoords, InteractiveCanvasAppState } from "@excalidraw/excalidraw/types/types";
import History from "@excalidraw/excalidraw/types/history";
...
export declare class LinearElementEditor {
    ...
    static duplicateSelectedPoints(appState: AppState): false | {
        appState: {
            ...
            contextMenu: {
                items: import("@excalidraw/excalidraw/types/components/ContextMenu").ContextMenuItems;
                top: number;
                left: number;
            } | null;
            ...
            activeEmbeddable: {
                element: import("@excalidraw/excalidraw/types/element/types").NonDeletedExcalidrawElement;
                state: "active" | "hover";
            } | null;
            draggingElement: import("@excalidraw/excalidraw/types/element/types").NonDeletedExcalidrawElement | null;
            resizingElement: import("@excalidraw/excalidraw/types/element/types").NonDeletedExcalidrawElement | null;
            multiElement: NonDeleted<ExcalidrawLinearElement> | null;
            selectionElement: import("@excalidraw/excalidraw/types/element/types").NonDeletedExcalidrawElement | null;
            isBindingEnabled: boolean;
            startBoundElement: NonDeleted<ExcalidrawBindableElement> | null;
            suggestedBindings: import("@excalidraw/excalidraw/types/element/binding").SuggestedBinding[];
            frameToHighlight: NonDeleted<import("@excalidraw/excalidraw/types/element/types").ExcalidrawFrameElement> | null;
            frameRendering: {
                enabled: boolean;
                name: boolean;
                outline: boolean;
            ...
            editingElement: import("@excalidraw/excalidraw/types/element/types").NonDeletedExcalidrawElement | null;
            activeTool: {
                lastActiveTool: import("@excalidraw/excalidraw/types/types").ActiveTool | null;
                locked: boolean;
            } & import("@excalidraw/excalidraw/types/types").ActiveTool;
            penMode: boolean;
            penDetected: boolean;
            ...
            currentItemFillStyle: import("@excalidraw/excalidraw/types/element/types").FillStyle;
            currentItemStrokeWidth: number;
            currentItemStrokeStyle: import("@excalidraw/excalidraw/types/element/types").StrokeStyle;
            currentItemRoughness: number;
            currentItemOpacity: number;
            currentItemFontFamily: number;
            currentItemFontSize: number;
            currentItemTextAlign: string;
            currentItemStartArrowhead: import("@excalidraw/excalidraw/types/element/types").Arrowhead | null;
            currentItemEndArrowhead: import("@excalidraw/excalidraw/types/element/types").Arrowhead | null;
            currentItemRoundness: import("@excalidraw/excalidraw/types/element/types").StrokeRoundness;
            ...
            isRotating: boolean;
            zoom: Readonly<{
                value: import("@excalidraw/excalidraw/types/types").NormalizedZoomValue;
            }>;
            ...
            lastPointerDownWith: import("@excalidraw/excalidraw/types/element/types").PointerType;
            ...
            theme: import("@excalidraw/excalidraw/types/element/types").Theme;
            ...
            collaborators: Map<string, import("@excalidraw/excalidraw/types/types").Collaborator>;
            showStats: boolean;
            currentChartType: import("@excalidraw/excalidraw/types/element/types").ChartType;
            pasteDialog: {
                shown: false;
                data: null;
            } | {
                shown: true;
                data: import("@excalidraw/excalidraw/types/charts").Spreadsheet;
            };
            pendingImageElementId: string | null;
            showHyperlinkPopup: false | "editor" | "info";
            selectedLinearElement: LinearElementEditor | null;
            snapLines: readonly import("@excalidraw/excalidraw/types/snapping").SnapLine[];
            originSnapOffset: {
                x: number;
                y: number;
            } | null;
