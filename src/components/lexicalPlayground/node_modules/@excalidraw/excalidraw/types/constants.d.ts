import { AppProps } from "@excalidraw/excalidraw/types/types";
import { ExcalidrawElement, FontFamilyValues } from "@excalidraw/excalidraw/types/element/types";
...
export declare const FRAME_STYLE: {
    strokeColor: string;
    strokeWidth: number;
    strokeStyle: import("@excalidraw/excalidraw/types/element/types").StrokeStyle;
    fillStyle: import("@excalidraw/excalidraw/types/element/types").FillStyle;
    roughness: number;
    roundness: {
        type: import("@excalidraw/excalidraw/types/element/types").RoundnessType;
